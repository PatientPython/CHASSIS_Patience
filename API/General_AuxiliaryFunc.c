...
bool IsRCConnected(void) {
    ...
    if (GST_Receiver.ST_RC.JoyStickL_Y < RCChannelValue_Min ||
        GST_Receiver.ST_RC.JoyStickL_Y > RCChannelValue_Max) {
        return false;
    }
    if (GST_Receiver.ST_RC.JoyStickR_X < RCChannelValue_Min ||
        GST_Receiver.ST_RC.JoyStickR_X > RCChannelValue_Max) {
        return false;
    }
    if (GST_Receiver.ST_RC.JoyStickR_Y < RCChannelValue_Min ||
        GST_Receiver.ST_RC.JoyStickR_Y > RCChannelValue_Max) {
        return false;
    }

    /*遥控器拨盘值异常，认为遥控器未连接*/
    if (GST_Receiver.ST_RC.Roller < RCChannelValue_Min ||
        GST_Receiver.ST_RC.Roller > RCChannelValue_Max) {
        return false;
    }
...
bool IsLeftJoyStickBeyondDeadZoneUp(void) {
    if (GST_Receiver.ST_RC.JoyStickL_Y >=
        (RCChannelValue_Mid + RCChannel_DeadZone)) {
        return true;
    } else {
        return false;
    }
