...
typedef enum
{ 
  GPIO_Mode_IN   = 0x00, /*!输入< GPIO Input Mode */
  GPIO_Mode_OUT  = 0x01, /*!输出< GPIO Output Mode */
  GPIO_Mode_AF   = 0x02, /*!复用< GPIO Alternate function Mode */
  GPIO_Mode_AN   = 0x03  /*!模拟< GPIO Analog Mode */
}GPIOMode_TypeDef;
...
typedef enum
{ 
  GPIO_Low_Speed     = 0x00, //2MHz                         /*!< Low speed    */
  GPIO_Medium_Speed  = 0x01, //25MHz                        /*!< Medium speed */
  GPIO_Fast_Speed    = 0x02, //50MHz                        /*!< Fast speed   */
  GPIO_High_Speed    = 0x03  //100MHz(30pH)或者80MHz(15pF)  /*!< High speed   */
}GPIOSpeed_TypeDef;
