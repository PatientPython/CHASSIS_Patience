...
typedef struct
{
    ...
    struct
    {
        ...
        /*一些标志位*/
        uint8_t ReloadStatus;       //待优化：原本是之前赛季的补弹标志位，由于规则改动，无需补弹功能，直接发false就行，后续可以删掉，记得IMU2里面也要一起删
...
typedef struct
{
    ...
    float Theta1FB;          //左腿相对机体垂直方向夹角，向后摆为正，单位度  //老代码说明：老代码叫AlphaLeftReal
    float Theta2FB;          //右腿相对机体垂直方向夹角，向后摆为正，单位度  //老代码说明：老代码叫AlphaRightReal
